...
import main1_jpg from "../assets/main1_.jpg";
import main2_jpg from "../assets/main2_.jpg";
import main3_jpg from "../assets/main3_.jpg";
...
import main_items_webp from "../assets/main-items_webp.webp";
import main_parts_webp from "../assets/main-parts_webp.webp";
import main_styles_webp from "../assets/main-styles_webp.webp";
  ...
  return (
    <div className="MainPage -mt-16">
      ...
      <div className="mx-auto">
        <ThreeColumns
          columns={[
            <Card webp={main1_webp} jpg={main1_jpg}>
              롱보드는 아주 재밌습니다.
            </Card>,
            <Card webp={main2_webp} jpg={main2_jpg}>
              롱보드를 타면 아주 신납니다.
            </Card>,
            <Card webp={main3_webp} jpg={main3_jpg}>
              롱보드는 굉장히 재밌습니다.
            </Card>,
          ]}
        />
        <TwoColumns
          bgColor={"#f4f4f4"}
          columns={[
            <img data-src={main_items} ref={imgRef1} alt="이미지" />,
            <Meta
              title={"Items"}
              content={
        ...
        <TwoColumns
          bgColor={"#fafafa"}
          columns={[
            <img data-src={main_parts} ref={imgRef2} alt="이미지" />,
            <Meta
        ...
        <TwoColumns
          bgColor={"#f4f4f4"}
          columns={[
            <img data-src={main_styles} ref={imgRef3} alt="이미지" />,
            <Meta
              title={"Riding Styles"}
              content={
